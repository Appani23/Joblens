  ...
  return (
    ...
    >
      ...
      <div className="flex items-start gap-2">
        <h2 className="flex-1 text-slate-100 font-semibold text-[0.95rem] leading-snug line-clamp-2">
          {job.title}
        </h2>
        <button
      ...
      <div className="flex items-center justify-between gap-2 mt-auto pt-3 border-t border-slate-800/80">
        <div className="flex items-center gap-2.5 min-w-0">
          ...
          <span className="text-xs text-slate-500 whitespace-nowrap">{timeAgo(job.postedDate)}</span>
        </div>
        {job.applyUrl && (
          <ApplyButton
            href={job.applyUrl}
